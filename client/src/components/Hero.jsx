...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <button className="bg-primary text-white px-10 py-3 rounded-lg hover:scale-95 transition cursor-pointer">
          Start creating now
        </button>
        <button
          className="bg-white px-10 py-3 rounded-lg border border-grey-300 
